...
//
// Adopted for COMP 142, fall 2026. Local changes:
//   - added resetMousePressed()
...
public class SimpleCanvas {
     ...
     * @param width the width of the canvas, in pixels
     * @param height the height of the canvas, in pixels
     * @param title the text shown in the window's title bar
     */
     ...
     * @param centerY the y-coordinate of the center of the oval
     * @param radiusX the horizontal radius of the oval, in pixels
     * @param radiusY the vertical radius of the oval, in pixels
     */
     ...
     *
     * @param xPoints the x-coordinates of the polygon's points
     * @param yPoints the y-coordinates of the polygon's points, in the same order as xPoints
     */
     ...
     * @param startAngle the angle at which the arc begins, in degrees
     * @param arcAngle how far the arc extends, in degrees; positive sweeps counterclockwise
     */
     ...
     *
     * @param x the x-coordinate that the text is centered on
     * @param y the y-coordinate of the baseline of the text
     * @param text the text to draw
     */
     ...
     * @param filename the file path, URL, or classpath resource of the image
     */
     ...
     * @param y the y-coordinate of the top left corner of the image
     * @param filename the file path, URL, or classpath resource of the image
     * @param width the width to scale the image to, in pixels
     * @param height the height to scale the image to, in pixels
     */
     ...
     * The filename can be a file path, URL, or classpath resource.
     *
     * @param centerX the x-coordinate of the center of the image
     * @param centerY the y-coordinate of the center of the image
     * @param filename the file path, URL, or classpath resource of the image
     * @param degrees how far to rotate the image, in degrees; positive rotates clockwise
     */
     ...
     *
     * @param size the line thickness, in pixels
     */
     ...
     *
     * @param enabled true to turn antialiasing on, false to turn it off
     */
     ...
     *
     * @return true if a mouse button is currently held down, false otherwise
     */
    ...
    /**
     * Clears the mouse-pressed flag. Call this after a modal dialog closes, so a
     * polling loop does not see a phantom held-down button: the dialog swallows
     * the mouseReleased event that would otherwise have cleared the flag.
     */
     ...
     *
     * @return the x-coordinate of the most recent mouse click
     */
     ...
     *
     * @return the y-coordinate of the most recent mouse click
     */
     ...
     *
     * @return true if a typed key character is available, false otherwise
     */
     ...
     *
     * @return the next key character that was typed
     * @throws NoSuchElementException if every keystroke has already been processed
     */
     ...
     *
     * @param keycode the key code to check, such as KeyEvent.VK_LEFT
     * @return true if that key is currently held down, false otherwise
     */
     ...
     * The filename can be a file path, URL, or classpath resource.
     *
     * @param filename the file path, URL, or classpath resource of the WAV file
     */
     ...
     *
     * @return the JPanel that this canvas draws on
     */
     ...
     *
     * @param filename the file path, URL, or classpath resource of the WAV file
     * @return an open audio stream for the file
     * @throws UnsupportedAudioFileException if the file is not in a supported audio format
